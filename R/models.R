...
if (cfg$model_version==1) {
  par_init <- c(a_x=-6.2967, g_x1=-0.1535, g_x2=0.9796, t_x1=0.5343, a_s=-2.3111, g_s1=-0.5649, g_s2=0.6198, t_s1=0.4245, beta_x=1.401, a_y=-5.5786, g_y1=0.3278, g_y2=4.2046, t_y=-0.7198)
} else if (cfg$model_version==2) {
...
if (cfg$model_version==1) {
  ...
  terms_y2_F <- function(x, j, w_1, w_2) { c(1, j, w_1, w_2, x) }
...
if (cfg$model_version==1) {
  ...
  terms_s2_F <- function(j, w_1, w_2) { c(1, j, w_1, w_2) }
